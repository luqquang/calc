...
import com.luqqorp.calculator.utils.NodesInformation;
...
class CalculationTest {
   ...
   void testOverflow() throws Exception {
      ...
      //lowest positive number 1e-9999 e.g. 0.999........9999 (9999 fraction digits)
       testCalculation(NodesInformation.LOWEST_POSITIVE_NUMBER_EXPRESSION, "1e-9999", 1, "0");
      //reaching positive fraction overflow 9.e-10000 e.g. 0.0........0001 (10000 fraction digits)
       testException("10 ÷ 9 = m+ c " + NodesInformation.LOWEST_POSITIVE_NUMBER_EXPRESSION + " ÷ mr =", new OverflowException(), 1, "1.1111111111111111");    //Overflow

      //highest negative number -1e-9999 e.g. 0.999...9999 (9999 fraction digits)
       testCalculation(NodesInformation.HIGHEST_NEGATIVE_NUMBER_EXPRESSION, "-1e-9999", 1, "0");
      //reaching negative fraction overflow -9.e-10000 e.g. 0.0...0001 (10000 fraction digits)
       testException("10 ÷ 9 = m+ c " + NodesInformation.HIGHEST_NEGATIVE_NUMBER_EXPRESSION + " ÷ mr =", new OverflowException(), 1, "1.1111111111111111");   //Overflow
      ...
      //lowest number -9.999999999999999e9999 e.g. -999999999999999949...999999.9999999999999...9999 (10000 integer digits, 9999 fraction digits,0, "0");
       testCalculation(NodesInformation.LOWEST_NUMBER_EXPRESSION, "-9.999999999999999e9999", 1, "1e9983");
      //reaching positive overflow -9.e-10000 e.g. 0.0...0001 (10000 fraction digits)
       testException(NodesInformation.LOWEST_NUMBER_EXPRESSION + " mc m+ c " + NodesInformation.HIGHEST_NEGATIVE_NUMBER_EXPRESSION + " + mr =", new OverflowException(), 1, "-9.999999999999999e9999");
      ...
      //highest positive number 9.999999999999999e9999 e.g. 999999999999999949...999999.9999999999999...9999 (10000 integer digits, 9999 fraction digits,0, "0");
       testCalculation(NodesInformation.HIGHEST_NUMBER_EXPRESSION, "9.999999999999999e9999", 0, "1e9983");
      //reaching positive overflow 9.e-10000 e.g. 0.0...0001 (10000 fraction digits)
       testException(NodesInformation.HIGHEST_NUMBER_EXPRESSION + " mc m+ c " + NodesInformation.LOWEST_POSITIVE_NUMBER_EXPRESSION + " + mr =", new OverflowException(), 1, "9.999999999999999e9999");
