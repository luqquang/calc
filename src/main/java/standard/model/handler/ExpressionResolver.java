 ...
 * depending of its logic and assumes the result value
 * Supported operations: add, substract, multiply, divide,
...
public class ExpressionResolver {
   ...
   /**
    * Handles expression depending by operation
    ...
    * If operation is new it calculate percentage of itself and sets
    ...
    * If operation is new it rewrite second operand with the result
    * If operation isn't new it rewrite second operand with first operand
    *
